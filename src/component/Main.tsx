...
export class Main extends React.Component<IMainProps,IMainStates> {
    ...
    constructor(props:any){
        super(props);
        this.state={searchString:"",UserList:[],visiblePage:0,visibleUserProfile:{},inProgress:false};
    ...
    findUsers=()=>{
        ...
        let requestUrl=`https://api.github.com/search/users?q=${this.state.searchString}`;
    ...
    getUser=()=>{
        return this.state.UserList.map((user:any)=>{
          ...
          return  <SearchUserView userInfo={user} setViewProfile={this.setViewProfile}/>
